...
function addArtist(array, id, name, years, genre, bio){
  array.push({id, name, years, genre, bio});
  return array;
  }
console.log(addArtist(artists, 20, "Liza", "1990-present", "USA", "Modern expresionist painter. Highly skilled at painting nature."));
